      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
        {loading ? (
          ...
          <div className="p-8 text-center text-gray-500">
            <p className="mb-4">No sales invoices found</p>
            <Link
              href="/sales/invoices/new"
                  ...
                  {invoices.map((invoice) => (
                    <tr key={invoice._id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        {invoice.is_registered && (
                          <span className="ml-2 text-xs text-green-600">FBR</span>
                        )}
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        ...
                        {invoice.status === 'Draft' && (
                          <Link
                            href={`/sales/invoices/${invoice._id}/edit`}
